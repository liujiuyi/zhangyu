...
elseif ($_REQUEST['act'] == 'export_orders')
{
   /* 查询 */
   $sql = "SELECT o.order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
    ...
    $str = "订单号,下单时间,收货人,收货地址,总金额,应付金额\n";
    $str = iconv('utf-8','gb2312',$str);
    foreach ($order_list as $key => $val)
    {
       $order_sn = "\t".iconv('utf-8','gb2312',$val[order_sn]);
       $short_order_time = "\t".iconv('utf-8','gb2312',local_date('m-d H:i', $val[add_time]));
       $consignee = iconv('utf-8','gb2312',$val[consignee]);
       $address = iconv('utf-8','gb2312',$val[address]);
       $formated_total_fee = iconv('utf-8','gb2312',price_format($val[total_fee]));
       $formated_order_amount = iconv('utf-8','gb2312',price_format($val[order_amount]));
       $str .= $order_sn.",".$short_order_time.",".$consignee.",".$address.",".$formated_total_fee.",".$formated_order_amount."\n"; //用引文逗号分开
    }
    //设置文件名
