...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
	...
	create_html_editor2('goods_ggbz','goods_ggbz', $goods['goods_ggbz']);
	create_html_editor2('goods_shfw','goods_shfw', $goods['goods_shfw']);
    /* 模板赋值 */
    $smarty->assign('code',    $code);
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id, goods_ggbz, goods_shfw)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id' ,'$_POST[goods_ggbz]','$_POST[goods_shfw]')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral,goods_ggbz, goods_shfw)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral','$_POST[goods_ggbz]','$_POST[goods_shfw]')";
        }
    }
    else
    {
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
				...
				"goods_ggbz = '$_POST[goods_ggbz]', " .
				"goods_shfw = '$_POST[goods_shfw]', " .
                "last_update = '". gmtime() ."', ".
...
//-- 修改猜你喜欢状态
/*------------------------------------------------------ */
elseif ($_REQUEST['act'] == 'toggle_like')
{
    check_authz_json('goods_manage');

    $goods_id       = intval($_POST['id']);
    $is_like        = intval($_POST['val']);

    if ($exc->edit("is_like = '$is_like', last_update=" .gmtime(), $goods_id))
    {
        clear_cache_files();
        make_json_result($is_like);
    }
}
...
//-- 修改最热评状态
/*------------------------------------------------------ */
elseif ($_REQUEST['act'] == 'toggle_comment')
{
    check_authz_json('goods_manage');

    $goods_id       = intval($_POST['id']);
    $is_hot_comment        = intval($_POST['val']);

    if ($exc->edit("is_hot_comment = '$is_hot_comment', last_update=" .gmtime(), $goods_id))
    {
        clear_cache_files();
        make_json_result($is_hot_comment);
    }
}
