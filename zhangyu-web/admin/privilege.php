...
elseif ($_REQUEST['act'] == 'modif')
{
    ...
    /* 获得当前管理员数据信息 */
    $sql = "SELECT user_id, user_name, email, nav_list, role_id, LPAD(user_id, 4, 0) invite_code ".
...
{
    $list = array();
    $sql  = 'SELECT user_id, user_name, email, add_time, last_login, role_id, LPAD(user_id, 4, 0) invite_code '.
