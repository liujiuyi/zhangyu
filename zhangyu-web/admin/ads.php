...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据 */
	//by guan start 添加了hot_comment_content字段
    $sql = "INSERT INTO ".$ecs->table('ad'). " (position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,link_man,link_email,link_phone,click_count,enabled,hot_comment_content)
...
elseif ($_REQUEST['act'] == 'update')
{
	...
	//by guan start 添加了hot_comment_content字段
			"hot_comment_content = '$_POST[hot_comment_content]', " .
