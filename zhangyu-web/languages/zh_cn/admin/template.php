...
$_LANG['template_files']['flash_sale'] = '限时抢购模板';
/* 每一个库项目的描述 */
$_LANG['template_libs']['recommend_friend'] = '首页友情推荐';
$_LANG['template_libs']['ad_position'] = '广告位';
$_LANG['template_libs']['index_ad'] = '首页主广告位';
$_LANG['template_libs']['index_service'] = '首页特色服务';
$_LANG['template_libs']['index_only_yhd'] = '首页专享';
...
$_LANG['template_libs']['head-service_1'] = '顶部购物车右侧切换窗口1';
$_LANG['template_libs']['head-service_2'] = '顶部购物车右侧切换窗口2';
$_LANG['template_libs']['head-service_3'] = '顶部购物车右侧切换窗口3';
$_LANG['template_libs']['cat_title_1'] = '首页分类商品标题1';
$_LANG['template_libs']['cat_title_2'] = '首页分类商品标题2';
$_LANG['template_libs']['cat_title_3'] = '首页分类商品标题3';
$_LANG['template_libs']['cat_brand_1'] = '首页分类商品左侧图片链接1';
$_LANG['template_libs']['cat_brand_2'] = '首页分类商品左侧图片链接2';
$_LANG['template_libs']['cat_brand_3'] = '首页分类商品左侧图片链接3';
$_LANG['template_libs']['cat_right_ad'] = '首页分类商品右侧图片广告';
