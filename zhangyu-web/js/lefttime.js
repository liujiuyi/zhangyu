...
function showtime()
{
  ...
  if (dateLeft > 0)
  {
    Temp = dateLeft + '<span style="color:#333">'+_day +'</span>'+ hourZero + hourLeft + '<span  style="color:#333">'+_hour+'</span>' + minuteZero + minuteLeft + '<span  style="color:#333">'+_minute +'</span>'+ secondZero + secondLeft + '<span style="color:#333">'+_second+'</span>';
  ...
  else
  {
    ...
    if (hourLeft > 0)
    {
      Temp = hourLeft + '<span style="color:#333">'+_hour+'</span>' + minuteZero + minuteLeft + '<span  style="color:#333">'+_minute+'</span>' + secondZero + secondLeft + '<span style="color:#333">'+_second+'</span>';
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = minuteLeft + '<span  style="color:#333">'+_minute+'</span>' + secondZero + secondLeft + '<span  style="color:#333">'+_second+'</span>';
      }
      else
      {
        if (secondLeft > 0)
        {
          Temp = secondLeft + '<span  style="color:#333">'+_second+'</span>';
        }
        else
        {
          Temp = '';
