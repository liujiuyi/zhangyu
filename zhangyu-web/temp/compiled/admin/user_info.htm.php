...
?>
  ...
  <?php if ($this->_var['form_action'] == "update"): ?>
  <tr>
    <td class="label">是否配发邀请码:</td>
    <td><?php echo $this->html_radios(array('name'=>'is_invite','options'=>$this->_var['lang']['is_invite'],'checked'=>$this->_var['user']['is_invite'])); ?></td>
  </tr>
  <?php endif; ?>
  <tr>
...
<table width="100%" >
  <tr>
    ...
    <td><?php echo $this->_var['user_shop']['shop_name']; ?></td>
  </tr>
  <tr>
    <td class="label">店铺联系人:</td>
    <td><?php echo $this->_var['user_shop']['shop_contacts']; ?></td>
  </tr>
  <tr>
    <td class="label">店铺电话:</td>
    <td><?php echo $this->_var['user_shop']['shop_mobile']; ?></td>
  </tr>
  <tr>
    <td class="label">店铺地址:</td>
    <td><?php echo $this->_var['user_shop']['shop_address']; ?></td>
  </tr>
  <tr>
    <td class="label">店铺照片:</td>
    <td>
      <?php $_from = $this->_var['user_shop_pic']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'shop_pic');if (count($_from)):
    foreach ($_from AS $this->_var['shop_pic']):
?>
        <a href="../mobile/<?php echo $this->_var['shop_pic']['pic']; ?>" target="_blank"><img src="../mobile/<?php echo $this->_var['shop_pic']['pic']; ?>" width="100" height="100" border="0" /></a>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </td>
  </tr>
</table>
