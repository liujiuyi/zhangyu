...
<div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    ...
    &nbsp;店铺审批 <select name="wholesale_status"><option value="0">所有状态</option><?php echo $this->html_options(array('options'=>$this->_var['wholesale_status_list'])); ?></select>
    ...
    &nbsp;<input type="button" name="export" value="导出会员" onclick="location.href='users.php?act=export_users';" class="button" />
  </form>
</div>
...
?>
  <tr>
    ...
    <td><?php echo $this->_var['user']['parent_admin_name']; ?></td>
...
function searchUser()
{
    ...
    listTable.filter['wholesale_status'] = document.forms['searchForm'].elements['wholesale_status'].value;
