...
function showtime(obj)
{
  ...
  if (dateLeft > 0)
  {
    Temp = "<h4>倒计时</h4><strong>"+dateLeft+"</strong>"+ ":" +"<strong>"+hourZero+hourLeft+"</strong>"+ ":" +"<strong>"+ minuteZero+minuteLeft+"</strong>"+ ":" +"<strong>"+secondZero+secondLeft+"</strong>";
  }
  else
  {
    if (hourLeft > 0)
    {
      Temp = "<h4>倒计时</h4><strong>" + hourLeft + "</strong>" + ":" + "<strong>" + minuteZero + minuteLeft + "</strong>" + ":" + "<strong>" + secondZero + secondLeft + "</strong>" + ":";
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = "<h4>倒计时</h4><strong>" + minuteLeft + "</strong>" + ":" + "<strong>" + secondZero + secondLeft + "</strong>";
      }
      else
      {
        if (secondLeft > 0)
        {
          Temp = "<h4>倒计时</h4><strong>" + secondLeft  + "</strong>" + _second;
        }
        else
        {
          Temp = '';
